...
1. Крючок (1-2 предложения) — провокационный, с цифрами или парадоксом, хватает за внимание. НЕ НАЧИНАЙ с «Многие люди» или «В современном мире» — это скучно. Начни с конкретного факта, вопроса или провокации.
2. Проблема (2-3 предложения) — конкретная боль, симптомы, масштаб. Не абстрактно, а с деталями.
3. История/Кейс (3-5 предложений) — КОНКРЕТНЫЙ пример с именем (можно вымышленным), цифрами, деталями. «Моя знакомая Маша» лучше чем «многие специалисты».
4. Инсайт/Анализ (5-7 предложений) — почему так, системный взгляд. Объясни механику, а не общие слова.
5. Решение/Действие (3-5 пунктов со стрелками →) — практические шаги. Каждый пункт — конкретное действие, не абстракция.
6. Вывод + CTA (1-2 предложения) — одна ключевая мысль + призыв к обсуждению.
...
- «Многие люди до сих пор убеждены...» — СКУЧНО. Начни с конкретики.
- «Главная мысль заключается в том, что...» — КАНЦЕЛЯРИТ. Просто скажи суть.
- «Причина этой проблемы заключается...» — ВОДЯНИСТО. Назови причину прямо.
- «Чтобы оставаться актуальными, нам нужно...» — ОБЩО. Дай конкретные шаги.
- «В заключение хочу сказать...» — ЛИШНЕЕ. Просто заверши мысль.
- Не повторяй одну мысль разными словами в соседних абзацах.
- Каждый абзац должен добавлять НОВУЮ мысль, а не пережёвывать старую.

СТИЛЬ:
- Пиши как человек, который ЗНАЕТ тему, а не как ChatGPT
- Используй разговорные обороты: «Вот пример», «Окей, но», «Серьёзно?»
