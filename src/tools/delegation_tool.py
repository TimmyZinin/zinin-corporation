...
DELEGATABLE_AGENTS = {
    ...
    "designer": {
        ...
        "skills": "дизайн, картинки, инфографика, графики, визуалы, видео, баннеры, обложки",
    },
}
...
class DelegateTaskInput(BaseModel):
    agent_name: str = Field(
        ...
        description=(
            ...
            "designer (Райан — дизайн, картинки, видео)"
        ),
    )
...
class DelegateTaskTool(BaseTool):
    ...
    description: str = (
        ...
        "• designer (Райан) — дизайн, картинки, инфографика, графики, видео, баннеры\n\n"
